    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-lg-9 mx-auto text-center">
          ...
          <p><span>May 20, 2020</span> <span className="mx-3" /> <span>by Admin</span></p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-8 blog-content">
          <p className="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda nihil aspernatur nemo sunt, qui, harum repudiandae quisquam eaque dolore itaque quod tenetur quo quos labore?</p>
          ...
          <div className="pt-5">
            ...
            <div className="comment-form-wrap pt-5">
              ...
              <form action="#" className="p-5 bg-light">
                ...
                <div className="form-group">
                  <input type="submit" defaultValue="Post Comment" className="btn btn-primary py-3 px-4 text-white" />
                </div>
              </form>
            </div>
          </div>
        ...
        <div className="col-md-4 sidebar">
          ...
          <div className="sidebar-box">
            ...
            <p><a href="#" className="btn btn-primary text-white">Read More</a></p>
          </div>
          <div className="sidebar-box">
